class Job < ApplicationRecord
  ...
  def self.review_script_bytes = Rails.configuration.x.mcp_sandbox_app.script_review_bytes
  def self.max_script_bytes = Rails.configuration.x.mcp_sandbox_app.script_max_bytes
